...
import json
import time
from archieve.MQTTSimulator import MQTTSimulator
...
instructions_text = Text(get_instructions_text(), position=(0.78, -0.2), origin=(0.5, 0), scale=1.0)
...
def update():
    ...
    if show_trajectory:
        ...
        if trail_timer >= trail_interval:
            ...
            if simulation_type == 'return':
                return_trails.append(trail)
            elif simulation_type == 'serve':
